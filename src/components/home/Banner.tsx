...
import log from "../../../public/blacklogo.png"
...
const Banner = () => {
   ...
   <div className="overflow-hidden">
       <div className="container mx-auto px-10">
           <div className="relative flex  h-[750px] items-center w-full  bg-white dark:bg-black">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-black"></div>
       <div className="absolute w-[500px] h-[500px] -bottom-40 -left-20 rounded-full bg-[#d5f139]  opacity-80 blur-[150px]"></div>
       <div className="absolute w-[250px] h-[250px] right-0 z-50 bottom-0 rounded-full bg-[#d5f139]  opacity-100 blur-[150px]"></div>
      
     
      <div className="px-10 z-50 flex items-center justify-between gap-20">
        {/* left sight content */}
        <div>
